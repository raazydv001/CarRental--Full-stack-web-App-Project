        ...
        text-sm mt-6 max-w-xl'>
            ...
            '>
                <div className='flex flex-col w-full'>
                    ...
                    mt-1 border border-borderColor rounded-md outline-none' value={car.year}
                    onChange={(e)=>setCar({...car,year:e.target.value})} />

                </div>
                <div className='flex flex-col w-full'>
                    <label htmlFor="">Daily Price ({currency}) </label>
                    <input type="number" placeholder='105' required className='px-3 py-2
                    mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay}
                 ...
                 <div className='flex flex-col w-full'>
                    ...
                    <select onChange={e=> setCar({...car,category:e.target.value})}
                        ...
                        <option value="Sedab">Sedan</option>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                <div className='flex flex-col w-full'>
                    ...
                    <select onChange={e=> setCar({...car,transmission:e.target.value})}
                        ...
                        <option value="Sedab">Automatic</option>
                 ...
                 <div className='flex flex-col w-full'>
                    ...
                    mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity}
            ...
            {/* Car Description */}
              <div className='flex flex-col w-full'>
                    ...
                    <textarea rows={5}
                     ...
                     and a powerful engine' required className='px-3 py-2
                    mt-1 border border-borderColor rounded-md outline-none' value={car.description}
